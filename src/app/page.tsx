          ...
          <div className="main__content">
            ...
            <div className="main__content__list">
              <p><b>&gt; </b> Вы можете получить бесплатную консультацию военного юриста онлайн или по телефону,
                ...
                <div className="line">
                  <div className="plus" style={{ fontSize: '35px', color: 'green' }}> + </div>
                  <p className="plusText"> у нас уже были такие обращения, то есть вопрос не трудозатратный и небольшой </p><br/>
                </div>
                <div className="line">
                  <div className="plus" style={{ fontSize: '35px', color: 'green' }}> + </div>
                  <p className="plusText"> консультация на тему компенсации по ранению или гибели военнослужащего </p><br/>
                </div>
                <div className="line">
                  <div className="plus" style={{ fontSize: '35px', color: 'green' }}> + </div>
        ...
        <div className="cases">
          <div className="cases__down">
            ...
            <div className="cases__down__list">
              ...
              {/*  <div className="cases__down__checklist__photos">*/}
              {/*    /!* eslint-disable-next-line @next/next/no-img-element *!/*/}
