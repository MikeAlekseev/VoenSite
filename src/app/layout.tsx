...
export const metadata: Metadata = {
    title: 'Консультация военного юриста - защита прав военнослужащих | ВПБ "Юстиция"',
    description: "Военный юрист - консультации, помощь военнослужащим, юрист по военным вопросам",
};
