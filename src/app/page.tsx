      ...
      <div className="feadback__stage">
        ...
        <div className="table-mobile">
          {[
            {
              name: "Тариф Лайт",
              data: ["+", "до 8", "2", "До 8", "2", "14500р"],
              tariff: "Лайт"
            },
            {
              name: "Тариф Оптима",
              data: ["+", "до 16", "4", "До 6", "4", "28500р"],
              tariff: "Оптима"
            },
            {
              name: "Тариф ВИП",
              data: ["+", "до 30", "6", "До 4 (в рабочее время)", "6", "38500р"],
              tariff: "ВИП"
            }
          ].map(({ name, data, tariff }) => (
              <div className="tariff-card" key={tariff}>
                <h3>{name}</h3>
                <ul>
                  <li>Персональный юрист: {data[0]}</li>
                  <li>Количество вопросов к юристу: {data[1]}</li>
                  <li>Консультации по телефону: {data[2]}</li>
                  <li>Время обработки запроса: {data[3]}</li>
                  <li>Оформление запросов: {data[4]}</li>
                  <li>Цена: {data[5]}</li>
                </ul>
                <BuySubscription tariff={tariff} />
              </div>
          ))}
        </div>
      </div>
          ...
          <div className="card">
            ...
            <div className="info">
              ...
              <div className="contacts">
                ...
                <br/><br/>
                <a href="https://t.me/vpbust" className="cases__down__checklist__btn">Написать Юристу</a>
              </div>
            </div>
          </div>
          <div className="card">
